...
function Navbar({searchTerm, setSearchTerm, user}) {
  ...
  return (
    <div class="flex flex-row p-50">
      <nav class="navbar bg-body-tertiary flex-row p-2 rounded-right mt-10 " style={{ outline : "none" , borderRadius: "50px"}}>
      <div class="container-fluid flex flex-row rounded-2">
        <form class="d-flex flex-row flex-10 w-100 rounded-right" role="search" styles={{userSelect: "none"}}>
